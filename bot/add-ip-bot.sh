#!/bin/bash
# // PROJECT XDXL STORE
url_izin="https://raw.githubusercontent.com/Tomketstore/izin/main/ip"
...
git clone https://github.com/awanklod/izin_jual.git /root/ipvps/ &> /dev/null
clear
echo -e ""
...
git push -f https://${TOKEN}@github.com/awanklod/izin_jual.git &> /dev/null
rm -rf /root/ipvps
clear
